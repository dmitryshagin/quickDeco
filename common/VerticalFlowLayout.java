...
* @param vgap An int value indicating the vertical seperation of the
     * components
     * @param alignment An int value which is one
     * of <code>RIGHT, LEFT, CENTER, BOTH</code> for the horizontal alignment.
     */
...
* @param vgap An int value indicating the vertical seperation of the
     ...
     * @param alignment An int value which is one
     * of <code>RIGHT, LEFT, CENTER, BOTH</code> for the horizontal alignment.
     * @param anchor An int value which is one
     * of <code>TOP, BOTTOM, CENTER</code> indicating where the components are
